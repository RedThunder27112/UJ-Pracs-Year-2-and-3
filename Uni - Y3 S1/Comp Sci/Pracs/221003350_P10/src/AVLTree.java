...
public class AVLTree<K extends Comparable<? super K>,V> extends BinaryTree<Entry<K,V>> {
    ...
    public BTPosition<Entry<K,V>> insert(K key, V value) {
        ...
        }else
        {
        	...
        	AVLNode<Entry<K,V>> right = new AVLNode(null, null,null,null);
        	
        	

        	
        	myInsertPos.setLeft(left);
        	myInsertPos.setRight(right);
        	
        	left.setParent(myInsertPos);
        	right.setParent(myInsertPos);
        	
        	//check balance
        	/*
         	System.out.println("--------------");
    		System.out.println(myInsertPos);
    		System.out.println(myInsertPos.parent());
    		System.out.println(myInsertPos.left());
    		System.out.println(myInsertPos.right());
    		System.out.println();
*/

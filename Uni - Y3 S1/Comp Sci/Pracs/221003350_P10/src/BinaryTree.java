...
public class BinaryTree<T> implements Iterable<T> {
	 ...
	 * @param node The BTPosition<T> node
	...
	/**
	 * Return true if the node is the root child
	 * @param node the BTPosition<T> node
	 * @return true if the node is the root child
	 */
	...
	/**
	 * Return the sibling of a passed node
	 * @param node the BTPosition<T> node
	 ...
	 * @param node the BTPostion<T> node
	 * @return true is this is an external node
	 */
	 ...
	 */
	protected BTNode<T> checkPosition(BTPosition<T> p) {
